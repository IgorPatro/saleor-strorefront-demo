...
import { CheckoutFormSchema, type CheckoutFormValues } from "./types";
...
export const useCheckoutForm = (
  ...
  const form = useForm<CheckoutFormValues>({
    ...
    defaultValues: {
      ...
      note: "",
      requireInvoice: !!checkoutData?.checkout?.billingAddress?.companyName,

      billingCompany: checkoutData?.checkout?.billingAddress?.companyName ?? "",
