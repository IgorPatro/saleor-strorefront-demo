...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string, checkout?: { __typename?: 'Checkout', id: string } | null, addresses: Array<{ __typename?: 'Address', id: string, city: string, postalCode: string, streetAddress1: string, firstName: string, lastName: string, phone?: string | null }>, orders?: { __typename?: 'OrderCountableConnection', edges: Array<{ __typename?: 'OrderCountableEdge', node: { __typename?: 'Order', id: string, status: OrderStatus, total: { __typename?: 'TaxedMoney', gross: { __typename?: 'Money', amount: number } } } }> } | null } | null };
