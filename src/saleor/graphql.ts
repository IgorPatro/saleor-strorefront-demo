...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, email: string, firstName: string, lastName: string, checkout?: { __typename?: 'Checkout', id: string } | null, addresses: Array<{ __typename?: 'Address', id: string, city: string, postalCode: string, streetAddress1: string, firstName: string, lastName: string, phone?: string | null }> } | null };
